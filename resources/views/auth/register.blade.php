                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="btn-group col-md-6" role="group" aria-label="role">
                            ...
                            <label class="btn btn-outline-primary rounded-2" for="btnradio1">Cliente</label>

                            <input type="radio" class="btn-check" name="role" id="btnradio2" value="desarrollador">
                            <label class="btn btn-outline-primary rounded-2" for="btnradio2">Desarrollador</label>
                          </div>
                        </div>
